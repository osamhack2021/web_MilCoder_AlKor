...
SECRET_PATH = os.path.join(DATA_DIR, 'config', 'secret.key')
if not is_production and not os.path.isfile(SECRET_PATH):
...
LOGGING_HANDLERS = ['console', 'sentry'] if is_production else ['console']
LOGGING = {
    'version': 1,
